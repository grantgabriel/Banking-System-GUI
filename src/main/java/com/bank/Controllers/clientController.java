...
public class clientController {
    ...
    public void register(javafx.scene.input.MouseEvent event) {
        ...
        //Close Windows When Click Register
    ...
    @FXML
    void Addclt(ActionEvent event) {

        Parent root = null;

        try {
            URL url = new File("src/main/resources/com/bank/Views/AddClient.fxml").toURI().toURL();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_Add.setOnMouseClicked((event) -> {
            try {
                URL  url1 = new File("src/main/resources/com/bank/Views/AddClient.fxml").toURI().toURL();
